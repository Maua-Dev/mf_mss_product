...
class Test_ManageConnectionPresenter:
    ...
    def test_manage_connection_presenter_default_error(self):
        ...
        assert json.loads(response["body"]) == "Field $default is not a acceptable route_key value, must be $connect or $disconnect"
