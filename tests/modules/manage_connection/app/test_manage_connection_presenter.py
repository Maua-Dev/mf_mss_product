...
class Test_ManageConnectionPresenter:
    def test_create_connection_presenter(self):
        ...
        assert json.loads(response["body"])["connection"]["user_id"] == "93bc6ada-c0d1-7054-66ab-e17414c48abb"
        assert json.loads(response["body"])["connection"]["restaurant"] == 'CANTINA_DO_MOLEZA'
