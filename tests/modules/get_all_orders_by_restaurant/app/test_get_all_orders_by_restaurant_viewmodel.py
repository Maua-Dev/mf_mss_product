...
from src.modules.get_all_orders_by_restaurant.app.get_all_orders_by_restaurant_viewmodel import GetAllOrdersByRestaurantViewmodel
...
class Test_GetAllOrdersByRestaurantViewmodel:
    def test_get_all_active_orders_by_restaurant_viewmodel(self):
        ...
        all_orders = usecase(user_id=repo_user.users_list[3].user_id, order_id="1eeef881-1b1f-4f38-a662-8ff7156e6c27")
