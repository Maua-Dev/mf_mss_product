...
from src.modules.request_upload_product_photo.app.request_upload_product_photo_presenter import lambda_handler


class Test_RequestUploadProductPhotoPresenter:
