    ...
    def __init__(self):
        self.users_list = [
            User(name="Lucas Duez", email="lucas.santos@gmail.com", role=ROLE.ADMIN,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48ae3", confirm_user=True, restaurant=None, photo="https://img.freepik.com/free-photo/red-white-cat-i-white-studio_155003-13189.jpg?w=2000"),
            User(name="Vitor Sollas", email="vitinho.dev@maua.br", role=ROLE.ADMIN,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48ae5", confirm_user=True, restaurant=None, photo="https://images.unsplash.com/photo-1608848461950-0fe51dfc41cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mnx8fGVufDB8fHx8fA%3D%3D&w=1000&q=80"),
            User(name="Laura Carolina", email="email.da.laura@gmail.com", role=ROLE.OWNER,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48abb", confirm_user=True, restaurant=RESTAURANT.CANTINA_DO_MOLEZA, photo="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Cat03.jpg/640px-Cat03.jpg"),
            User(name="João Brancas", email="brancas.dev@gmail.com", role=ROLE.OWNER,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48af4", confirm_user=True, restaurant=RESTAURANT.SOUZA_DE_ABREU, photo="https://hips.hearstapps.com/hmg-prod/images/dog-puppy-on-garden-royalty-free-image-1586966191.jpg?crop=0.752xw:1.00xh;0.175xw,0&resize=1200:*"),
            User(name="Lucas Milas", email="milas@maua.br", role=ROLE.USER,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48gbf", confirm_user=True, restaurant=None, photo="https://img.freepik.com/free-photo/puppy-that-is-walking-snow_1340-37228.jpg"),
            User(name="Rodrigo Morales", email="rodrigo.morales@gmail.com", role=ROLE.USER,
                 user_id="93bc6ada-c0d1-7054-66ab-e17414c48af9", confirm_user=True, restaurant=None, photo="https://static.vecteezy.com/system/resources/thumbnails/017/323/715/small/3d-render-adorable-close-up-of-a-american-eskimo-dog-holding-red-rose-in-mouth-on-white-background-photo.jpg"),
            ...
            User(name="Gabriel G Godoy", email="warrior@ww2.flutter", role=ROLE.USER,
                 user_id="93bc6ada-c0d1-7054-42je-e17414c48af1", confirm_user=True, restaurant=None, photo="https://img.freepik.com/fotos-gratis/pug-bonito-em-roupas-de-exercito_23-2148348097.jpg?w=826&t=st=1693438194~exp=1693438794~hmac=cce4d75839448ae01788d50b6c61881e23c57ca290b8a8c60dea932d73a387ac")
        ]
