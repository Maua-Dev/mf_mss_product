...
class GetAllOrdersByRestaurantViewmodel:
    ...
    def to_dict(self):
        return {
            'all_orders_by_restaurant': [OrderViewmodel(order).to_dict() for order in self.all_orders] if len(self.all_orders) > 0 else [],
